...
Dogecoin peers are obtained from DNS seeds. Its target block interval is one minute. Dogecoin is merge-mined with Litecoin, which should be considered when comparing mining activity across the two networks.
